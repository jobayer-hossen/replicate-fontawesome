...
const Navbar = () => {
    ...
    <>
      ...
      {/*<!-- Header --> */}
      <header className="relative z-20 w-ful bg-white/90  after:absolute after:top-full after:left-0 after:z-10 after:block after:h-px after:w-full after:bg-slate-200 lg:border-slate-200 lg:backdrop-blur-sm lg:after:hidden">
        <div className="relative mx-auto max-w-full px-6 lg:max-w-5xl xl:max-w-7xl 2xl:max-w-[96rem]">
          ...
          >
            ...
            >
                <img className='w-[10%]' src="https://www.drupal.org/files/project-images/font_awesome_logo.png" alt="" />
