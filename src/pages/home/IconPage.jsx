...
<div id='icon' className="mt-5 mb-5">
     ...
     <section className="relative w-[80%] mx-auto bg-white" aria-multiselectable="false">
...
<div
    ...
    >
      <button
        // @click="sidenav = true"
        class="p-2 border-2 bg-white rounded-md border-gray-200 shadow-lg text-gray-500 focus:bg-blue-400 focus:outline-none focus:text-white absolute top-0 left-0 sm:hidden"
      >
        <svg
        ...
        <div class="space-y-6 md:space-y-10 mt-10">
          ...
          <div id="menu" class="flex flex-col space-y-2">
            ...
            <button
              ...
              class="text-sm font-medium text-gray-700 py-2 px-2 hover:bg-blue-400 hover:text-white hover:text-base rounded-md transition duration-150 ease-in-out text-left"
            >
              <svg
            ...
            <button
              ...
              class="text-sm font-medium text-gray-700 py-2 px-2 hover:bg-blue-400 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out text-left"
            >
              <svg
                class="w-6 h-6 fill-current inline-block"
                fill="currentColor"
            ...
            <a
              href=""
              class="text-sm font-medium text-gray-700 py-2 px-2 hover:bg-blue-400 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out"
            >
              <svg
                class="w-6 h-6 fill-current inline-block"
                fill="currentColor"
      ...
      <div className={`w-[100%] ms-8 mx-auto grid gap-8 ${foreColumn ? 'grid-cols-4' : 'grid-cols-2' }
        `}>
